...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/home/sasha/Documents/Personal Projects/torch/venv/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/home/sasha/Documents/Personal Projects/torch/venv=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/home/sasha/Documents/Personal Projects/torch/venv/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/home/sasha/Documents/Personal Projects/torch/venv' "
 ...
 'LIBFFI_INCLUDEDIR': '/home/sasha/Documents/Personal Projects/torch/venv/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/sasha/Documents/Personal Projects/torch/venv/lib/pkgconfig',
 'LIBPL': '/home/sasha/Documents/Personal Projects/torch/venv/lib/python3.7/config-3.7m-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/sasha/Documents/Personal Projects/torch/venv/include',
 'OPENSSL_LDFLAGS': '-L/home/sasha/Documents/Personal Projects/torch/venv/lib',
